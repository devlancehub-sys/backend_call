...
CREATE TABLE IF NOT EXISTS female_hosts (
  id                     INT            NOT NULL AUTO_INCREMENT,
  user_id                INT            NOT NULL,
  active_tier            ENUM('iron','silver','gold','diamond') NOT NULL DEFAULT 'iron',
  lifetime_talk_minutes  INT            NOT NULL DEFAULT 0,
  rate_per_minute        DECIMAL(8,2)   NOT NULL DEFAULT 6.00,
  day_host_share         DECIMAL(5,2)   NOT NULL DEFAULT 45.00,
  day_platform_share     DECIMAL(5,2)   NOT NULL DEFAULT 55.00,
  night_host_share       DECIMAL(5,2)   NOT NULL DEFAULT 50.00,
  night_platform_share   DECIMAL(5,2)   NOT NULL DEFAULT 50.00,
  is_content_creator     TINYINT(1)     NOT NULL DEFAULT 0,
  is_diamond_approved    TINYINT(1)     NOT NULL DEFAULT 0,
